...
const filteredCourses = computed(() => {
  let allCourses = [...courses.value, ...courses2.value, ...courses7.value, ...preview.value];
  ...
  if (activeTab.value === "health") {
    ...
    allCourses = courses7.value; // Individual courses // Individual courses
  }
...
<template>
  <Head title="Finance and Accounting | iCan Careers" />
  ...
  <div class="max-h-screen bg-gray-50 p-6">
    ...
    <div class="max-w-6xl mx-auto">
      <div><h1 class="text-[20px] text-gray-400">Results for "Fitness and Accounting"</h1></div>
        <CourtList category="finance" />
    </div>
  <Footer />
